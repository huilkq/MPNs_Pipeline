...
def print_pred_json(eval_data, eval_examples, preds, id2label):
    ...
    #     f.write('\n'.join(json.dumps(convert(doc)) for doc in js))
    return docs
...
if __name__ == "__main__":
    ...
    parser.add_argument("--train_file", default='D:\pythonProject\MPNs_PURE\Datasets\MNPs\\train.json', type=str,
                        help="The path of the training data.")
    parser.add_argument("--train_mode", type=str, default='random',
