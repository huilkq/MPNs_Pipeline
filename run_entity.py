...
if __name__ == '__main__':
    ...
    parser.add_argument('--data_dir', type=str, default="D:\pythonProject\MPNs_PURE\Datasets\MNPs",
    ...
    parser.add_argument('--model', type=str, default='D:\pythonProject\BIONER_ER\pre_models\matscibert',
    ...
    args.dev_data = os.path.join(args.data_dir, 'devel.json')
